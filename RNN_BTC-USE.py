import pandas as pd # 빅데이터 분석, csv읽는거, 필터링 편하게해줌
import numpy as np
...
seed가 컴퓨터의 현재 시간의 영향을 받아서 변경되니까 , seed값 고정을 통해 랜덤성 제거!
reproducablity(재현성)
'''
seed = 1234
np.random.seed(seed)
...
# 데이터 불러오기
dataraw = pd.read_csv('C:\\Users\knuser\PycharmProjects\Deep_Learning\.1\data\BTC-USD.csv',
                      index_col='Date', parse_dates=['Date'])
# pandas를 이용하면 정렬하면서 데이터를 불러올 수 있음, column명을 통해 그 데이터만 가져올 수 있음
